...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2VvcmdlYXJpb24iLCJhIjoiY2tmeHkzenNhMjR6dzJ5bXp2bWptcmVqbyJ9.gM4bc8pjaQb38Ur7coqyVA';
...
var forgot = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, forgotBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var reset = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password, passwordConfirm, token, resetBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_51HecrhAyZWbJUHNvAaHHHYjFeAGj8Zbc6AOYmeNezcrO0UkNHoHEeEtrzavWwfxUADSgHCxpD4qQoHIW6iYjFqbt005A2ZKXoU');
...
if (forgotForm) {
  forgotForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email');
    var forgotButton = document.querySelector('button.btn-forgot');
    (0, _forgot.forgot)(email, forgotButton);
  });
}
...
if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password');
    var passwordConfirm = document.getElementById('passwordConfirm');
    var resetButton = document.querySelector('button.btn-reset');
    var token = resetButton.dataset.token;
    (0, _reset.reset)(password, passwordConfirm, token, resetButton);
  });
}
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('button.btn--save-password').textContent = 'Updating...';
            ...
            case 7:
              ...
              document.querySelector('button.btn--save-password').textContent = 'Save Password';
